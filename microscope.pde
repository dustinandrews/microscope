...
const int gnd_resetSteppers = 2;//ground to reset
const int disableSteppers = 4; //Enable on the A3967SLB is "Active Low", so the name is changed to make programming clearers.
const int gnd_sleepSteppers = 5;//ground to set boards to sleep mode.

//PWM pins are 3, 5, 6, 9, 10, and 11. Pins 5 and 6 have timing issues at low speeds.
const int motorA_step = 3;
const int motorB_step = 9;
const int motorC_step = 10;

const int motorA_dir  = 6;
const int motorB_dir  = 7;
const int motorC_dir  = 8;
